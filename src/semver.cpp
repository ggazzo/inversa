...
// Helper function to remove 'v' prefix if present
const char* removeVPrefix(const char* version) {
...
int compareSemVer(const char* version1, const char* version2) {
    ...
    version1 = removeVPrefix(version1);
    version2 = removeVPrefix(version2);
